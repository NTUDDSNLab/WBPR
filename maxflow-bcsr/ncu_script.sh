...
echo "\t start TC: $(date)"
ncu $ncu_flags -o $profiling_file_path/dbpedia-location_super_bcsr_TC.ncu-rep ./maxflow -v 2 -f $bipartite_file_path/dbpedia-location_super.txt -a 0 -t 1 -a 0
echo "\t end TC: $(date)"
echo "\t start TLPNS: $(date)"
ncu $ncu_flags -o $profiling_file_path/dbpedia-location_super_bcsr_TLPNS.ncu-rep ./maxflow -v 2 -f $bipartite_file_path/dbpedia-location_super.txt -a 0 -t 1 -a 1
echo "\t end TLPNS: $(date)"
echo "-------------------------------------------"
...
echo "\t start TC: $(date)"
ncu $ncu_flags -o $profiling_file_path/soc-LiveJournal1_cap1_bcsr_TC.ncu-rep ./maxflow -v 2 -f $snap_file_path/soc-LiveJournal1_cap1.txt -a 0 -t 1 -a 0
echo "\t end TC: $(date)"
echo "\t start TLPNS: $(date)"
ncu $ncu_flags -o $profiling_file_path/soc-LiveJournal1_cap1_bcsr_TLPNS.ncu-rep ./maxflow -v 2 -f $snap_file_path/soc-LiveJournal1_cap1.txt -a 0 -t 1 -a 1
echo "\t end TLPNS: $(date)"
echo "-------------------------------------------"
