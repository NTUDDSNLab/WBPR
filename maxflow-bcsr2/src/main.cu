...
int main(int argc, char **argv)
{
    ...
    CHECK(cudaMalloc((void**)&gpu_fflows, 2*E*sizeof(int))); // BCSR
    ...
    CHECK(cudaMemcpy(gpu_fflows, res_graph.forward_flows, 2*res_graph.num_edges*sizeof(int), cudaMemcpyHostToDevice)); // BCSR
